...
DATA = {
    ...
    "SoftBank": ("softbank", "SoftBank / Arm / AI投資", "hot", "IR / AI基盤", "corporate_ir_financing", "ソフトバンクグループ、株主総会前のQ&A更新でAIデータセンター投資の説明軸を追加", "フランス5GW計画の発表後、株主向けQ&AとIRニュースの並びでAIインフラ投資、資本政策、Arm保有価値の読み筋がそろった。", "ソフトバンクグループは、5月末に公表したフランスAIデータセンター計画の後、株主総会前のQ&AとIRニュースを並べ、AIインフラ投資と資本政策を同じIR文脈で読める状態にした。フランス案件は最大750億ユーロ、初期フェーズ450億ユーロ、3.1GWの整備計画を含む大型案件で、Armや通信子会社のAI基盤投資と合わせて、資産価値と資金負担の両面を見せる材料になっている。", "2026-06-01", ["https://group.softbank/en/news", "https://group.softbank/en/ir", "https://newsroom.arm.com/"], ["https://group.softbank/en/news", "https://group.softbank/en/ir", "https://www.reuters.com/technology/", "https://newsroom.arm.com/", "https://x.com/SoftBank_Group", "https://www.youtube.com/@SoftBankGroup", "https://www.bloomberg.com/technology"]),
    ...
    "F1": ("f1", "F1 / Honda F1", "signal", "レース結果", "race_schedule_results", "F1モナコGP、ピアストリ優勝でマクラーレンの主導権が広がる", "Formula 1公式結果でピアストリがモナコを制し、ノリスも上位。Honda/Astonは次戦に向けて市街地低速域の課題を残した。", "Formula 1公式のモナコGP結果では、オスカー・ピアストリが優勝し、マクラーレンがドライバーズとコンストラクターズの両面で勢いを保った。市街地コースでは空力効率だけでなく低速域のタイヤ管理とトラクションが結果を左右し、Aston Martin側はHondaとの2026年PU移行前に車体側の弱点を切り分ける段階にある。FIAの2026年規則情報と合わせると、PUだけでなく車体・運用の総合力が次の競争軸になる。", "2026-06-01", ["https://www.formula1.com/en/results.html", "https://www.fia.com/regulation/category/110", "https://www.astonmartinf1.com/en-GB/news"], ["https://www.formula1.com/en/results.html", "https://www.fia.com/regulation/category/110", "https://www.bbc.com/sport/formula1", "https://www.astonmartinf1.com/en-GB/news", "https://x.com/F1", "https://www.youtube.com/@Formula1", "https://www.reuters.com/sports/formula1/"]),
    "SpaceX": ("spacex", "SpaceX / 宇宙", "signal", "打ち上げ", "official_launch_manifest", "SpaceX、6月序盤の打ち上げ一覧でStarlinkとStarship後続対応を並行管理", "公式LaunchesとStarshipページでは、Falcon 9/Starlinkの定常運用とStarship試験後の検証が別系統で進む構図になった。", "SpaceXの公式Launchesページでは、6月序盤のFalcon 9とStarlink関連ミッションが並び、商業打ち上げの高頻度運用が続いている。一方でStarshipは、前回飛行後の機体・地上系統・規制対応を整理する段階にあり、Starlink定常運用とはリスクの種類が異なる。NASAやFAAの公開資料と合わせると、短期の売上に近いFalcon運用と、長期の輸送能力を担うStarship開発は別の時間軸で進んでいる。", "2026-06-01", ["https://www.spacex.com/launches/", "https://www.spacex.com/vehicles/starship/", "https://www.faa.gov/space/stakeholder_engagement/spacex_starship"], ["https://www.spacex.com/launches/", "https://www.spacex.com/vehicles/starship/", "https://www.reuters.com/technology/space/", "https://www.faa.gov/space/stakeholder_engagement/spacex_starship", "https://x.com/SpaceX", "https://www.youtube.com/@SpaceX", "https://spaceflightnow.com/"]),
    "YOASOBI / 幾田りら": ("yoasobi_ikuta", "YOASOBI / 幾田りら", "signal", "ライブ / リリース", "live_tour_performance", "幾田りら『Laugh』ツアー後半、韓国公演後の発信と公式ページが更新局面に", "アルバム『Laugh』とツアー日程を公式ページで再整理し、YOASOBI公式・スタッフSNS・YouTubeの発信を分けて追う材料になった。", "幾田りらの2nd Album『Laugh』関連では、国内公演から韓国公演までのツアー情報が公式ページにまとまり、終了後の写真・映像・追加発信がSNSとYouTubeに分かれて出る段階に入った。YOASOBI本体の発表と幾田りらソロの発表は対象が異なるため、公式HP、スタッフX、YouTubeを分けると、楽曲リリース、ライブ余韻、次のタイアップ情報を混同せずに読める。", "2026-06-01", ["https://www.yoasobi-music.jp/news/", "https://ikuralilas.com/", "https://www.youtube.com/@Ayase_YOASOBI"], ["https://www.yoasobi-music.jp/news/", "https://ikuralilas.com/", "https://natalie.mu/music", "https://www.oricon.co.jp/news/music/", "https://x.com/YOASOBI_staff", "https://www.youtube.com/@Ayase_YOASOBI", "https://www.billboard-japan.com/"]),
