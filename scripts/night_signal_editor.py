...
def edit_evidence(
    ...
    """Reject the retired hosted-model path at its old public boundary."""
    del issue_date, evidence_path, state_root, token
    fail(
        "direct hosted-model editing is retired; use "
        "night_signal_plus_editor.py --prepare/--apply-review"
    )
