...
def copy_fixture() -> Path:
    ...
    shutil.copyfile(ROOT / "scripts" / "night_signal_models.py", tmp / "scripts" / "night_signal_models.py")
    ...
    shutil.copyfile(ROOT / "config" / "night_signal_models.json", tmp / "config" / "night_signal_models.json")
