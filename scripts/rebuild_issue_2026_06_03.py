...
from topic_value_engine import evaluate_topic_value

ROOT = Path(__file__).resolve().parents[1]
DATE = "2026-06-03"
CHECKED = "2026-06-03T20:55:00+09:00"
WINDOW_START = "2026-06-02T20:40:00+09:00"
...
DATA = {
    ...
    "F1": ("f1", "F1 / Honda F1", "signal", "開催予定", "race_schedule_results", "F1モナコGP、6月7日決勝に向けた公式タイムテーブルを公開", "Formula 1公式タイムテーブルでは、モナコGPは6月5-7日開催、決勝は6月7日に78周で行われる予定。6月3日時点で結果は未掲載。", "Formula 1は2026年モナコGPの公式タイムテーブルを掲載し、週末は6月5日から7日、決勝は6月7日に3.337kmの市街地コースを78周で行う予定としている。公式結果一覧では6月3日時点でモナコGPの順位やタイムはまだ掲載されていないため、勝者や順位としては扱わない。Honda/Aston Martin側は開催前の市街地コース適性、低速域、車体側の改善余地を読む段階で、レース結果ではなく予定と準備情報として見る。", "2026-06-03", ["https://www.formula1.com/en/latest/article/formula-1-louis-vuitton-grand-prix-de-monaco-2026.5eqj7xSRWW6dylGmncfs6T", "https://www.formula1.com/en/results.html", "https://www.astonmartinf1.com/en-GB/news"], ["https://www.formula1.com/en/latest/article/formula-1-louis-vuitton-grand-prix-de-monaco-2026.5eqj7xSRWW6dylGmncfs6T", "https://www.formula1.com/en/results.html", "https://www.bbc.com/sport/formula1", "https://www.astonmartinf1.com/en-GB/news", "https://x.com/F1", "https://www.youtube.com/@Formula1", "https://www.reuters.com/sports/formula1/"]),
    "SpaceX": ("spacex", "SpaceX / 宇宙", "signal", "打ち上げ", "official_launch_manifest", "SpaceX、公式LaunchesにCRS-34と6月ミッション予定を掲載", "公式Launchesは6月ミッションとしてCRS-34などを表示。Falcon運用とStarship開発は、収益化済み運用と長期輸送能力で別の時間軸にある。", "SpaceXの公式Launchesページは、6月のミッション一覧にCRS-34などの打ち上げ予定を表示している。6月3日号では、個別の打ち上げ結果を断定せず、公式Launchesに載った予定情報として扱う。Falcon 9/Dragonの商業・ISS補給運用は高頻度で売上に近い一方、Starshipは機体、地上系統、規制対応を積み上げる開発案件で、同じSpaceXでもリスクと時間軸が違う。", "2026-06-03", ["https://www.spacex.com/launches/", "https://www.spacex.com/vehicles/starship/", "https://www.faa.gov/space/stakeholder_engagement/spacex_starship"], ["https://www.spacex.com/launches/", "https://www.spacex.com/vehicles/starship/", "https://www.reuters.com/technology/space/", "https://www.faa.gov/space/stakeholder_engagement/spacex_starship", "https://x.com/SpaceX", "https://www.youtube.com/@SpaceX", "https://spaceflightnow.com/"]),
    "YOASOBI / 幾田りら": ("yoasobi_ikuta", "YOASOBI / 幾田りら", "signal", "ライブ結果", "live_tour_performance", "幾田りら『Laugh』ソロツアー、ソウル公演で全6公演を完走", "5月23・24日にソウルのオリンピック公園オリンピックホールでファイナル公演を開催。ZICO、YENA、上白石萌歌、詩羽の出演も報じられた。", "幾田りらは、2nd Album『Laugh』を携えたソロツアー『幾田りら LIVE TOUR 2026 “Laugh”』を、神戸、横浜、ソウルの3都市6公演で実施した。オフィシャルレポートを掲載したORICON NEWSによると、ファイナル公演は5月23日、24日に韓国・ソウルのオリンピック公園オリンピックホールで開催され、ZICO、YENA、上白石萌歌、詩羽が出演した。6月3日号では、YOASOBI本体の新曲発表ではなく、幾田りらソロ名義のツアー完走と韓国公演のゲスト出演を扱う。", "2026-05-25", ["https://www.oricon.co.jp/news/2456676/full/", "https://lilasikuta.jp/laugh/", "https://www.youtube.com/@Ayase_YOASOBI"], ["https://www.yoasobi-music.jp/news/", "https://lilasikuta.jp/laugh/", "https://natalie.mu/music", "https://www.oricon.co.jp/news/2456676/full/", "https://x.com/YOASOBI_staff", "https://www.youtube.com/@Ayase_YOASOBI", "https://www.billboard-japan.com/"]),
    ...
    "北米経済": ("north_america", "北米経済", "macro", "ISM / 製造業", "us_prices_jobs_fed", "米5月ISM製造業PMIは54.0、4年ぶり高水準でも価格と供給不安が残る", "ISM製造業PMIは5月54.0で、4月から1.3ポイント上昇。Axiosは6月2日に、イラン情勢、燃料コスト、供給網の不確実性を企業コメントとして伝えた。", "米ISM製造業PMIは5月に54.0となり、4月の52.7から1.3ポイント上昇して2022年5月以来の高水準になった。ISMのまとめは、AI投資や税制要因で製造業が拡大を続けている一方、回答企業がイラン情勢、燃料コスト、供給網の不確実性を警戒している点も示している。6月2日のAxiosも、指数の改善と同時に在庫積み増しや供給不安が混在する「まだらな回復」として扱った。景況感は改善しているが、価格圧力の沈静化とハードデータの追認がなければ、雇用統計と金利見通しの材料は一方向に固まらない。", "2026-06-02", ["https://www.axios.com/2026/06/02/manufacturing-ism-trump-iran", "https://www.ismworld.org/supply-management-news-and-reports/news-publications/inside-supply-management-magazine/blog/2026/2026-06/ism-pmi-reports-roundup-may-2026-manufacturing/", "https://www.investing.com/news/economy-news/us-manufacturing-activity-scales-fouryear-high-in-may-ism-says-4719623"], ["https://www.axios.com/2026/06/02/manufacturing-ism-trump-iran", "https://www.ismworld.org/supply-management-news-and-reports/news-publications/inside-supply-management-magazine/blog/2026/2026-06/ism-pmi-reports-roundup-may-2026-manufacturing/", "https://www.reuters.com/markets/us/", "https://www.federalreserve.gov/newsevents.htm", "https://home.treasury.gov/", "https://www.cnbc.com/economy/", "https://www.youtube.com/@CNBCtelevision"]),
    "宇都宮ブレックス": ("brex", "宇都宮ブレックス", "hot", "B.LEAGUE", "club_roster_staff", "宇都宮ブレックス、B.LEAGUE AWARD特設ページで受賞情報を継続掲載", "B.LEAGUE公式特設ページは2025-26シーズン表彰項目を掲載。6月3日時点でブレックスの新規契約・退団発表は本文化しない。", "B.LEAGUE公式のAWARD SHOW 2025-26特設ページは、レギュラーシーズンMVP、ベスト5、チャンピオンシップMVPなどの表彰項目と受賞情報を継続掲載している。6月3日号では、表彰ページと宇都宮ブレックス公式ニュースを分けて見たうえで、契約、退団、スタッフ変更として本文カードにする新規発表は確認できない。表彰は背景として重要だが、移籍やロスター確定情報と混同しない。", "2026-05-29", ["https://www.bleague.jp/award-show/2025-26/", "https://www.utsunomiyabrex.com/news/", "https://www.youtube.com/@UTSUNOMIYABREX"], ["https://www.utsunomiyabrex.com/news/", "https://www.bleague.jp/award-show/2025-26/", "https://www.shimotsuke.co.jp/", "https://www.bleague.jp/news/", "https://x.com/utsunomiyabrex", "https://www.youtube.com/@UTSUNOMIYABREX", "https://basketballking.jp/"]),
}
...
CLAIM_VERIFICATION = {
    ...
    "F1": [
        ...
        {"claim_type": "status", "source_state": "confirmed_status", "evidence_kind": "official_result", "claim": "6月3日時点でFormula 1公式結果一覧にモナコGPの決勝結果は掲載されていない。", "source_url": "https://www.formula1.com/en/results.html"},
    ],
    "SpaceX": [
...
DATA.update(
    {
        "SoftBank": (
            ...
            "ソフトバンクグループのフランスAIデータセンター計画は、6月3日号では発表そのものよりも、巨大な電力需要と資金負担を同時に読む材料として扱う。公式発表では最大5GWの容量、第1フェーズ450億ユーロ、Hauts-de-France地域圏の3.1GW整備、2031年までの工程が示されている。海外報道は最大750億ユーロ規模とフランスの原子力を含む電力供給力に注目しており、GPUやArmだけでなく、電力、土地、設備供給、長期資金をそろえられるかが実行リスクになる。",
            "2026-05-31",
            [
        ...
        "F1": (
            ...
            "Aston Martin",
            "honda_aston_pu",
            "Aston Martin、モナコGP向けMaaden特別リバリーを6月3日に公開",
            "Aston Martin AramcoはMaadenとモナコGP向け特別リバリーを公開。6月5-7日の開催前に、Hondaワークス初年度の露出とスポンサー文脈が加わった。",
            "Aston Martin Aramcoは6月3日、Principal PartnerのMaadenと組んだモナコGP向け特別リバリーを公開した。公式LinkedInでは、原材料から高性能エンジニアリングへ変わる流れを表現する企画として説明され、モナコの市街地レースで通常カラーとは違う見え方を狙う内容になっている。Formula 1公式カレンダー上のモナコGPは6月5日から7日の開催予定で、6月3日時点では結果ではなく事前発表とプロモーションの段階にある。Hondaワークス初年度のAston Martinは競技結果だけでなく、スポンサー露出、車体イメージ、低速市街地での注目度も同じ週末の材料になる。",
            "2026-06-03",
            [
        ...
        "SpaceX": (
            ...
            "SpaceX、6月3日にSLC-40発Starlinkミッションを設定",
            "公式Launchesは6月3日のFalcon 9 / Starlinkミッションを示す。Starshipとは別に、低軌道通信網の定常運用が続く。",
            "SpaceXの公式Launchesでは、6月3日にフロリダ州SLC-40からFalcon 9でStarlinkミッションを行う予定が示されている。Falcon 9の再使用とStarlink衛星配備は、Starship開発とは別の収益・運用軸として高頻度で続いている。Starshipは公式ページとFAA資料で機体、地上系統、規制対応の確認が続く領域であり、6月3日のStarlinkミッションとはリスクの種類が異なる。短期の通信網拡張と長期の大型輸送能力を分けると、同じSpaceXでも投資判断に効く時間軸が変わる。",
            "2026-06-03",
            [
        ...
        "日本経済": (
            ...
            "日銀講演",
            "prices_wages_boj",
            "植田日銀総裁、6月3日講演で物価・金融政策の判断材料を提示",
            "日銀は6月3日、植田総裁の講演「Economic Activity and Prices, and Monetary Policy in Japan」を掲載。中東情勢、原油、賃金、利上げ判断の関係が焦点になる。",
            "日本銀行は6月3日、植田総裁による講演「Economic Activity and Prices, and Monetary Policy in Japan」を最新講演として掲載した。講演は、海外情勢と原油価格が日本の物価に波及する可能性、企業の賃金・価格設定行動、金融政策を判断する際の上振れリスクと下振れリスクを同じ枠で扱う材料になる。5月マネタリーベースのような量的統計とは違い、6月3日の講演は市場が利上げ経路を読むための言葉の変化に近い。為替、長期金利、春闘後の賃金確認を結びつけるうえで、次回会合までの発言管理が注目点になる。",
            "2026-06-03",
            [
                "https://www.boj.or.jp/en/announcements/press",
                "https://www.forexfactory.com/news/1401673-ueda-economic-activity-and-prices-and-monetary-policy",
        ...
        "アジア経済": (
            ...
            "ADB週次表、香港輸出42.9%とシンガポールGDP6.0%でアジアの濃淡を示す",
            "ADB AsianBondsOnlineの6月1日週次表は、香港輸出42.9%、輸入44.4%、シンガポールGDP6.0%などを並べ、今週のVietnam PMI予定も示した。",
            "AsianBondsOnlineの6月1日週次データ表は、アジア域内の直近指標を一枚で見比べる材料になった。香港の4月輸出は前年比42.9%、輸入は44.4%と大きく伸び、シンガポールの1-3月期GDP改定値は前年比6.0%へ上方修正された。一方で、同じ週次表はVietnamの5月S&P Global Manufacturing PMI予定も示しており、製造業の足元確認はこれから続く。中国PMIだけを見ると50.0の境目に注目が集まるが、6月3日号では貿易、GDP、PMI予定を横に並べ、アジア供給網の強弱が国ごとに分かれている点を重視する。",
            "2026-06-01",
            [
                "https://asianbondsonline.adb.org/newsletters/abowdh20260601.pdf?src=spotlight",
        ...
        "宇都宮ブレックス": (
            ...
            "B.LEAGUE AWARD 2025-26でニュービルが3年連続MVPを受賞。6月3日号では3暦日枠を超えるため背景扱いにする。",
            "宇都宮ブレックスは、B.LEAGUE AWARD 2025-26でD.J・ニュービルが3年連続MVPを受賞した。表彰は個人の実績を示す一方、6月3日号の今日・昨日・一昨日枠では元情報が古くなるため、公開本文では契約、スタッフ、補強に関する新しい確定発表が出た場合だけ扱う。",
            "2026-05-29",
            [
...
CLAIM_VERIFICATION.update(
    {
        ...
        "F1": [
            {"claim_type": "announcement", "source_state": "confirmed_update", "evidence_kind": "direct_source", "claim": "Aston Martin AramcoがMaadenとのモナコGP向け特別リバリーを6月3日に公開した。", "source_url": "https://www.linkedin.com/company/astonmartinf1"},
            {"claim_type": "schedule", "source_state": "scheduled", "evidence_kind": "official_calendar", "claim": "2026年モナコGPは6月5日から7日の開催予定で、6月3日時点では開催前である。", "source_url": "https://www.formula1.com/en/racing/2026/monaco/"},
        ],
        "SpaceX": [
            {"claim_type": "announcement", "source_state": "confirmed_update", "evidence_kind": "official_release", "claim": "SpaceX公式Launchesページに6月3日のStarlinkミッション情報が掲載されている。", "source_url": "https://www.spacex.com/launches/"},
            {"claim_type": "schedule", "source_state": "scheduled", "evidence_kind": "official_calendar", "claim": "6月3日にSLC-40からFalcon 9 / Starlinkミッションを行う予定が示されている。", "source_url": "https://www.spacex.com/launches/"},
        ...
        "日本経済": [
            {"claim_type": "announcement", "source_state": "confirmed_update", "evidence_kind": "official_release", "claim": "日本銀行が6月3日に植田総裁の講演を最新講演として掲載した。", "source_url": "https://www.boj.or.jp/en/announcements/press"},
            {"claim_type": "status", "source_state": "confirmed_status", "evidence_kind": "major_media_confirmation", "claim": "市場系メディアは同講演を物価、原油、利上げ判断の材料として即時に扱った。", "source_url": "https://www.forexfactory.com/news/1401673-ueda-economic-activity-and-prices-and-monetary-policy"},
        ],
        "アジア経済": [
            {"claim_type": "numeric", "source_state": "published_value", "evidence_kind": "official_dataset", "claim": "ADB週次表で香港輸出42.9%、輸入44.4%、シンガポールGDP6.0%などの直近値を確認した。", "source_url": "https://asianbondsonline.adb.org/newsletters/abowdh20260601.pdf?src=spotlight"},
            {"claim_type": "schedule", "source_state": "scheduled", "evidence_kind": "official_calendar", "claim": "同じ週次表はVietnamの5月S&P Global Manufacturing PMI予定を示している。", "source_url": "https://asianbondsonline.adb.org/newsletters/abowdh20260601.pdf?src=spotlight"},
            {"claim_type": "status", "source_state": "confirmed_status", "evidence_kind": "official_dataset", "claim": "ADB週次表でアジア域内の貿易、GDP、PMI予定を同じ時点の確認材料として扱える。", "source_url": "https://asianbondsonline.adb.org/newsletters/abowdh20260601.pdf?src=spotlight"},
        ],
    }
)
...
def slug(section: str) -> str:
    return f"{section}-signal-2026-06-03.html"
...
def topic_value_decision(label: str, row: tuple) -> dict:
    _, _, _, _, _, title, _, summary, _, sources, _ = row
    return evaluate_topic_value(
        {
            "title": title,
            "summary": summary,
            "claim_verification": CLAIM_VERIFICATION[label],
            "sources": sources,
        }
    )
...
def is_published(label: str, row: tuple) -> bool:
    return (
        label not in MANUAL_UNPUBLISHED_CATEGORIES
        and source_age_days(row[8]) in LATEST_THREE_DAY_LABELS
        and topic_value_decision(label, row)["adoption_decision"] == "adopt"
    )
...
def cat_entry(label: str, conf: dict, row: tuple, contract: dict) -> dict:
    ...
    fresh_eligible = label not in MANUAL_UNPUBLISHED_CATEGORIES and source_age_days(source_date) in LATEST_THREE_DAY_LABELS
    topic_value = topic_value_decision(label, row) if fresh_eligible else None
    published = bool(topic_value and topic_value["adoption_decision"] == "adopt")
    ...
    for topic in conf["watch_topics"]:
        candidate_topic = topic["id"] == adopted_topic and topic_value is not None
        adopted = published and candidate_topic
        cand_title = title if candidate_topic else f"{label} {topic['id']}: 6月3日の近接候補は本文化水準に届かず"
        src = sources[0] if candidate_topic else official[0]
        cand = {
            "topic_id": topic["id"], "title": cand_title, "source_url": src,
            "source_published_date": source_date if candidate_topic else DATE,
        ...
        if adopted:
            cand["topic_value_class"] = topic_value["topic_value_class"]
            cand["reader_delta"] = topic_value["reader_delta"]
            cand["materiality_basis"] = topic_value["materiality_basis"]
        elif candidate_topic and topic_value["adoption_decision"] == "reject":
            cand["non_adoption_reason_class"] = topic_value["reject_reason_class"] or "no_material_change"
            cand["rationale"] = topic_value["reject_reason"] or "題材価値が不足するため公開カードにしない。"
            cand["publication_assessment"] = topic_value["materiality_basis"]
        if not adopted:
            cand.setdefault("non_adoption_reason_class", "no_material_change")
        cands.append(cand)
